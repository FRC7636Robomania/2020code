...
public class TrajectoryCommand extends CommandBase {
    ...
    public TrajectoryCommand(
      Trajectory trajectory, Supplier<Pose2d> pose,
      ...
      Supplier<DifferentialDriveWheelSpeeds> wheelSpeeds, BiConsumer<Double, Double> outputVolts,
      Subsystem requirement, Subsystem requirement2) {
